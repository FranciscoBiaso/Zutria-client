...
function CharacterList.create(characters, account, otui)
  ...
  if account.premDays > 0 and account.premDays < 65535 then
    accountStatusLabel:setText(tr("Conta vip com (%s) dias restantes.", account.premDays))
  elseif account.premDays >= 65535 then
    accountStatusLabel:setText(tr("Conta vip por toda vida!"))
  else
    accountStatusLabel:setText(tr('Conta comum'))
  end
...
function CharacterList.doLogin()
  ...
  if selected then
    ...
    displayErrorBox(tr('Erro'), tr('Você deve selecionar um avatar para jogar!'))
  end
end
