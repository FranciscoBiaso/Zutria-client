MAP_SHADERS = {
  ...
  { name = 'Fog', vert = 'shaders/fog.vert', frag = 'shaders/fog.frag', tex1 = 'images/clouds.png' },
...
local lastShader
local areas = {                    
{from = {x = -200, y = -2000, z = 7}, to = {x = 780, y = 2000, z = 7}, name = 'Fog'},
}
...
function init()
   ...
   for _i,opts in pairs(MAP_SHADERS) do
     local shader = g_shaders.createVertexShader(opts.name, opts.vert)
   ...
   map:setMapShader(g_shaders.getShader('Fog'))
end
